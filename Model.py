...
class Model:
  def __init__(self, summary_prefix, mode = None, reuse_scope=None):
    ...
    if reuse_scope is None:  # train model
      ...
      if mode is "demo_mode":
        self.query_video = tf.placeholder(tf.float32, shape=(128, 128, 3, 5))
    ...
    if reuse_scope and FLAGS.mode is "valid_mode":
