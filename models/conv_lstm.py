'''
Code obtained from Tensorflow authors
https://github.com/tensorflow/models/blob/master/video_prediction/lstm_ops.py
...
def basic_conv_lstm_cell(inputs,
  ...
  with tf.variable_scope(scope, default_name='BasicConvLstmCell', values=[inputs, state], reuse=reuse):
